 ...
 \begin{document}
 	...
 	\include{Capitolo-1}   	 % 1. Obiettivi
 	\include{Capitolo-2}  	 % 2. Modello Concettuale
 	\include{Capitolo-3}	 % 3. Generazione numeri random
	\include{Capitolo-4}	 % 4. Modello delle Specifiche
	\include{Capitolo-5}     % 5. Modello Computazionale
 	\include{Capitolo-6}     % 6. Verifica
 	\include{Capitolo-7}     % 7. Validazione
 	\include{Capitolo-8}     % 8. Progettazione Esperimenti
 	\include{Capitolo-9}     % 9. Simulazioni
 	\include{Capitolo-10}    % 10. Analisi dei Risultati

 	\appendix
 	\include{Appendice-A}      % Codice sorgente
	\include{Appendice-B} 	   % Grafici dei test
 \end{document} 
